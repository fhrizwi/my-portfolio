...
export default function HireMe() {
  return (
    <section className="bg-white text-black px-6 md:px-10 py-12 md:py-20 rounded-2xl relative overflow-hidden flex flex-col md:flex-row items-center justify-between max-w-6xl mx-auto shadow-md hover:shadow-lg transition-all duration-300 ease-in-out hover:-translate-y-1 hover:scale-[1.01] mt-8 gap-8">
      {/* Background Shapes */}
