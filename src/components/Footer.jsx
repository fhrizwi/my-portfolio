...
export default function Footer() {
    return (
        <>
            <footer className="bg-white text-gray-800 flex flex-col lg:flex-row gap-8 p-4 sm:p-8 lg:p-16 justify-between items-start lg:items-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-8 sm:gap-16">
                        ...
                        <div>
                            ...
                            <div className="text-gray-500 text-sm sm:text-base flex flex-col items-start space-y-1">
                                <a href="https://github.com/fhrizwi" target="_blank" rel="noopener noreferrer">Github</a>
                                <a href="https://www.linkedin.com/in/faizul-haque-rizwi-2aa05732a/" target="_blank" rel="noopener noreferrer">LinkedIn</a>
                                <a href="https://instagram.com/fhrizwi" target="_blank" rel="noopener noreferrer">Instagram</a>
                                <a href="https://twitter.com/fhrizwi" target="_blank" rel="noopener noreferrer">Twitter</a>
                            </div>
                        </div>
                    </div>
