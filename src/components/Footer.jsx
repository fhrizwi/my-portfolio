...
export default function Footer() {
  return (
    <>
      ...
      <div className="border-t-[2px] border-dashed text-gray-400 py-4 flex items-center justify-center p-3 flex-col text-xs sm:text-sm">
        <p className="hover:text-sky-500 transition duration-300">
          © 2025 Faizul.dev. All rights reserved.
        </p>
      </div>
    </>
  );
